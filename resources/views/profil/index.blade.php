    ...
    <div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="card text-center shadow-lg p-4" style="border-radius: 20px; max-width: 350px; width: 100%;"> 
            ...
            <div class="text-start mt-3">
                <h4 class="fw-bold mb-1"><strong>Nama:</strong> {{ Auth::user()->nama }}</h4>
                <p class="text-muted mb-1"><strong>Username:</strong> {{ '@' . Auth::user()->username }}</p>
                <p class="text-muted mb-1"><strong>Level Pengguna:</strong> {{ Auth::user()->level->level_nama ?? '-' }}</p>
            </div>
